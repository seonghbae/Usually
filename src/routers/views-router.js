...
viewsRouter.use('/admin/category', serveStatic('category-show'));
viewsRouter.use('/admin/product/add', serveStatic('product-add'));
viewsRouter.use('/admin/product/edit/:productId', serveStatic('product-edit'));
